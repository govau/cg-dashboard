...
// TODO(jonathaningram): just want this styling, but not a list.
const Section = ({ styler, children }) => (
  <div className={styler('complex_list')}>{children}</div>
);
...
const Header = ({ styler, children }) => (
  <header className={styler('complex_list-header')}>
    <h4 className={styler('complex_list-title')}>{children}</h4>
  </header>
);
