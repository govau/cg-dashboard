...
describe("routes", function() {
  ...
  describe("checkAuth()", function() {
    beforeEach(function() {
      sandbox
        .stub(loginActions, "fetchStatus")
        .returns(Promise.resolve({ status: "authorized" }));
    ...
    describe("given multiple arguments", function() {
      ...
      it("calls userActions.fetchCurrentUser() with guids for filtered API calls", function() {
        expect(userActions.fetchCurrentUser).toHaveBeenCalledWith(
          sinon.match({
            orgGuid: "orgGuid",
            spaceGuid: "spaceGuid"
          })
    ...
    describe("given unauthorized response", function() {
      ...
      beforeEach(function(done) {
        ...
        loginActions.fetchStatus.returns(
